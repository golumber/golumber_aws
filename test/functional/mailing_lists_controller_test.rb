...
class MailingListsControllerTest < ActionController::TestCase
  ...
  test "should create mailing_list" do
    assert_difference('MailingList.count') do
      post :create, mailing_list: { contact_first: @mailing_list.contact_first, contact_last: @mailing_list.contact_last, email: @mailing_list.email }
    end
  ...
  test "should update mailing_list" do
    put :update, id: @mailing_list, mailing_list: { contact_first: @mailing_list.contact_first, contact_last: @mailing_list.contact_last, email: @mailing_list.email }
    assert_redirected_to mailing_list_path(assigns(:mailing_list))
  end
